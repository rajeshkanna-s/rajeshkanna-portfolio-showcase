...
const site = { slug: 'morimatcha', title: 'MORI Matcha', url: 'https://rajeshkanna-s.github.io/mori-matcha/' };
...
async function captureHero() {
  ...
  for (const providerUrl of providers) {
    try {
      console.log(`[TRYING] ${site.title} (${site.slug}) via ${providerUrl.substring(0, 70)}...`);
